...
## [4.0.3]
- Исправлены ошибки на TopGG
- Исправлены ошибки на TopG (спасибо WildBlueBerry)
- Исправлены ошибки на DiscordBotList
- Исправлены ошибки на MinecraftMp (попытка отвязаться от рекламы)
...
Решение ReCaptcha в фоновом режиме - а значит почти все рейтинги вывести по умолчанию в тихий режим
Редактирование уже добавленного проекта    
По просьбе Konerd#6045 добавить число показывающее сколько уже добавлено проектов/серверов/аккаунтов/прокси
