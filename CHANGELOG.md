...
- Куки CloudFlare больше не очищаются
...
## [6.7.1 HotFix] - 2022-04-21
### Fixed
- Исправление ошибок с LowerCase при выборе рейтинга в настройках с ListForge и MineServers
- Исправление некоректного обновления бд до версии 7 (сейчас версия 8)

## [6.7.2] - 2022-05-07
### Added
- Добавлена поддержка https://mcservertime.com/

### Fixed
- Исправление ошибок на https://www.minecraft-servers-list.org/
- Исправление ошибок на https://craft-list.net/
- Исправление назначения времени следующего голосовать при ошибке "Вы уже голосовали" на https://czech-craft.eu/
- На https://minecraftrating.ru/ ввели reCaptcha, исправляем
- https://minecraftrating.ru/ теперь проксиевый рейтинг
- На https://topcraft.ru/ и https://mctop.su/ больше нет ошибки over HTTPS, исправляем
