...
После ребрендинга добавить следующие рейтинги:   
по просьбе Илья(Billy)#7815 https://space-engineers.com/ позже выяснилось что это сеть рейтинтов https://listforge.net/, Minecraft-Mp следует переименовать в ListForge и добавить поддержку всех рейтингов данной сети   
по просьбе vSnipeX#3021 https://mc-servers.com/   
по просьбе Razored#0360 https://minecraftlist.org/   
по просьбе Razored#0360 и fightfire#0001 https://www.minecraft-index.com/   
по просьбе vSnipeX#3021 https://serverlist101.com/server/1547/vote/   
также добавить все рейтинги которые поддерживает данный сайт https://toplistvoter.com/ (скриншот на случай если сайт сдохнет: http://ipic.su/img/img7/fs/Snimok11.1607325493.png)   
Сделать возможность кастомного голосования через исходный код в режиме эмуляции   
