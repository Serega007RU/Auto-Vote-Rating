...
## [3.3.2]
### Added
- Теперь в настройках в добавленных проектах отображается ошибка в проекте если произошла ошибка при голосовании
- По просьбе maksim#4344 в рейтинг MinecraftRating добавлен Borealis.su
- По просьбе caadr#6320 в рейтинг MonitoringMinecraft добавлен SimpleMinecraft.ru
...
Добавить top-serveurs.net (он же top-games.net) (по просьбе Julien Lavaud)
Реализовать статистику голосований (по просьбе Kitulous#3691)
Реализовать модалку которая будет открываться на проект в добавленных проектах в котором будет статистика, его настройки, всякие кнопочки относящиеся конкретно к выбранному проекту и т.д.
