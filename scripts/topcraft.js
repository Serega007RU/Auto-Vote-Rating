...
const timer = setInterval(()=>{
    try {
        ...
        if (document.readyState === 'complete' && document.querySelectorAll('div[class=tooltip-inner]').item(0) != null) {
            ...
            } else if (textContent.includes('некорректный ник') || textContent.includes('ваш айпи попал в базу данных спамеров') || (textContent.includes('код ошибки')) && textContent.includes('обновить страницу')) {
